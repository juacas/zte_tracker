...
class zteClient:
    ...
    def get_pon_optical_info(self) -> dict[str, Any]:
        ...
        try:
            ...
            # Volt/Current/RFTxPower are plain ints of unconfirmed unit, left out rather than guessed at.
    ...
    def reboot(self) -> bool:
        ...
        try:
            ...
            if self.paths.get("reboot_check_encrypted", True):            
                ...
                # H2640 and similar: the router directly verifies
                # SHA256(post_data) in hexadecimal, without RSA encryption.
                check_header = digest_str
            headers = {
                "Check": check_header,
